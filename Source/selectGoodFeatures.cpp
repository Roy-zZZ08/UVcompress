    ...
    selectionMode mode)
{
    ...
    if (tc->writeInternalImages) {
        _KLTWriteFloatImageToPGM(floatimg, "..\\Resource\\kltimg_sgfrlf.pgm");
        _KLTWriteFloatImageToPGM(gradx, "..\\Resource\\kltimg_sgfrlf_gx.pgm");
        _KLTWriteFloatImageToPGM(grady, "..\\Resource\\kltimg_sgfrlf_gy.pgm");
    }
